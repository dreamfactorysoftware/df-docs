...
If you have received a license key and package files from DreamFactory, see [Activating Your License](activating-your-license.md) to apply them to your Docker instance.
