...
description: DreamFactory generates governed REST APIs for any data source — databases, files, IoT — with RBAC, SSO, and zero backend code.
keywords: [DreamFactory platform, DreamFactory features, DreamFactory api management platform features, governed API access, REST API, API management, enterprise API platform, self-hosted API, DreamFactory overview, dreamfactory api]
difficulty: beginner
---
...
|---|---|---|
| Auto-generated REST APIs | Instantly generate fully documented REST APIs for 20+ database types — no backend code required | [Database APIs](/api-generation-and-connections/api-types/database/generating-a-database-backed-api) |
