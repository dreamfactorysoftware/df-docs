...
This guide explains how to configure Google OAuth in DreamFactory with automatic role assignment based on Google Workspace group membership (optional).
...
Domain-wide delegation allows the OAuth flow to access group membership information. This is required if you want to configure Google group to DreamFactory Role mappings, otherwise the OAuth flow will give the user the default role assignment for the service.

### Step 1: Access API Controls

1. Go to [Google Workspace Admin Console](https://admin.google.com)
2. Navigate to **Security** → **API controls** (you can also just search for API controls to navigate directly)
...
3. Click **Add new**
4. Enter the **Client ID** from your OAuth credentials 
